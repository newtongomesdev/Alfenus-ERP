    ...
    return (
      <Card>
        <CardContent className="p-6 text-center text-sm text-muted-foreground">
          Todos os cadastros de clientes foram atualizados recentemente.
        </CardContent>
      </Card>
    );
  }
            ...
            <div className="flex-1 min-w-0">
              ...
              {client.last_contact && (
                <p className="text-xs text-muted-foreground mt-1">
                  {client.reason === "Sem contato registrado" ? "Nenhum contato registrado" : `Último contato: ${formatDate(client.last_contact)}`}
