...
export default async function RecebivablesPage({ searchParams }: { searchParams: Promise<{ registrado?: string; cobranca?: string; erro?: string; estornado?: string; duplicado?: string; page?: string; de?: string; ate?: string; status?: string }> }) {
