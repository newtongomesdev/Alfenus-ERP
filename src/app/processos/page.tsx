...
export default async function ProcessesPage({
  ...
  try {
    ...
    if (context.status !== "ready" || !context.member || !context.lawFirm) {
      unavailableStatus = context.status;
    } else {
  ...
  if (unavailableStatus || !context.member || !context.lawFirm) {
    return <ProcessesUnavailable status={unavailableStatus ?? context.status} />;
  }
