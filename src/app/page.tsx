    ...
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/10">
      ...
      <section className="relative overflow-hidden border-b border-border/40 py-20 lg:py-32">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-16 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
          <div className="max-w-3xl space-y-6">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl lg:leading-[1.1]">
            ...
            <div className="grid gap-3 pt-6 text-xs font-medium text-muted-foreground sm:grid-cols-3">
          ...
          <div className="relative rounded-2xl border border-border/50 bg-card p-6 shadow-2xl shadow-foreground/5 backdrop-blur-sm lg:p-8">
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={card.label} className="rounded-xl border border-border/40 bg-muted/30 p-4 transition-all hover:bg-muted/50">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {features.map((feature) => {
            ...
            return (
              <article key={feature.title} className="group relative rounded-2xl border border-border/40 bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/20 hover:shadow-md">
      ...
      <section id="sobre-nos" className="overflow-hidden border-y border-border/40 bg-muted/15 py-24">
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-4 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
          <div className="relative min-h-[360px] overflow-hidden rounded-2xl border border-primary/20 bg-primary p-8 text-primary-foreground shadow-xl shadow-primary/10 sm:p-10">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 max-w-5xl mx-auto">
            {testimonials.map((t, idx) => (
              <div key={idx} className="flex flex-col justify-between rounded-2xl border border-border/40 bg-card p-8 shadow-sm">
      ...
      <section className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          {faqs.map((faq, idx) => (
            <div key={idx} className="rounded-2xl border border-border/40 bg-card p-6 shadow-sm">
