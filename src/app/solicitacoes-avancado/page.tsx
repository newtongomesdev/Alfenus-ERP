...
const subModules = [
  { label: "Pedidos", href: "/solicitacoes-avancado/pedidos", key: "total" as const },
  { label: "Aprovações", href: "/solicitacoes-avancado/aprovacoes", key: "aprovacaoPendente" as const },
  { label: "Monitoramento SLA", href: "/solicitacoes-avancado/sla", key: "concluidas" as const },
];

export default async function SolicitacoesAvancadoDashboard() {
