...
export type Database = {
  public: {
    Tables: {
      law_firms: {
        Row: {
          ...
          trial_used: boolean;
          solo_pro_enabled: boolean;
          setup_diagnostic_completed_at: string | null;
          office_health_config: unknown;
          setup_diagnostic_answers: unknown;
          created_at: string;
          updated_at: string;
        };
        Insert: {
      ...
      pricing_idempotency_operations: {
        Row: {
          id: string;
          law_firm_id: string;
          actor_id: string;
    ...
    Functions: {
      calculate_office_health_score: {
        Args: {
          p_law_firm_id: string;
        };
        Returns: number;
      };
      generate_office_health_snapshot: {
        Args: {
          p_law_firm_id: string;
      ...
      create_pricing_scenario_version: {
        Args: {
          p_scenario_id: string;
          p_parameters: Json;
          p_calculation_result: Json;
          p_calculation_memory: Json;
          p_scenario_type?: string;
          p_currency?: string;
          p_total_amount_cents?: number;
          p_entry_amount_cents?: number;
          p_financed_amount_cents?: number;
          p_installment_count?: number;
          p_success_fee_percentage_bps?: number;
          p_success_fee_base_cents?: number;
          p_estimated_success_fee_cents?: number;
          p_monthly_fee_cents?: number;
          p_monthly_fee_count?: number;
          p_activate?: boolean;
        };
        Returns: Json;
      };
