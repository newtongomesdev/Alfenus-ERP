...
export interface SoloOverview {
  ...
  paidExpensesThisMonth: number;
  cashFlowThisMonth: number;
  expectedExpensesThisMonth: number;
  projectedCashFlowThisMonth: number;
...
export type SoloOverviewResult =
  | { status: "ready"; data: SoloOverview }
